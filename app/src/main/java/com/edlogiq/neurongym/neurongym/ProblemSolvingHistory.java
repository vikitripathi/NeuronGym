 ...
 */
public class ProblemSolvingHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_problem_history, container, false);
...
*/
        ...
        LineAndPointFormatter incomeFormat = new LineAndPointFormatter(
                Color.rgb(156, 39, 176),                   // line color(CYAN)
                Color.rgb(156, 39, 176),               // point color
