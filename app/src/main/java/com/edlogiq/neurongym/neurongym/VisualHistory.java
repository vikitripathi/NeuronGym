 ...
 */
public class VisualHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_visual_history, container, false);
...
*/
        ...
        LineAndPointFormatter incomeFormat = new LineAndPointFormatter(
                Color.rgb(233, 30, 99),                   // line color(CYAN)
                Color.rgb(233, 30, 99),               // point color
