 ...
 */
public class FlexibilityHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_flexibility_history, container, false);
...
*/
        ...
        LineAndPointFormatter incomeFormat = new LineAndPointFormatter(
                Color.rgb(245, 127, 23),                   // line color(CYAN)
                Color.rgb(245, 127, 23),               // point color
