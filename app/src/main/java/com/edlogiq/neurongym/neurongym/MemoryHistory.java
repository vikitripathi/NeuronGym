 ...
 */
public class MemoryHistory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_memory_history, container, false);
...
*/
        ...
        LineAndPointFormatter incomeFormat = new LineAndPointFormatter(
                Color.rgb(244, 67, 54),                   // line color(CYAN)
                Color.rgb(244, 67, 54),               // point color
