...
public class BrainProfile extends ActionBarActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setCustomView(R.layout.actionbar_layout2);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_brain_profile, menu);
        return true;
    }
    ...
    /*public static class PlaceholderFragment extends Fragment {
        ...
        *//**
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_brain_profile, container, false);
            return rootView;
        }
    }*/
